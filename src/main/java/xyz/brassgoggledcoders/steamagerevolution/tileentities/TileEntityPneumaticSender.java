...
import xyz.brassgoggledcoders.steamagerevolution.blocks.BlockPneumaticSender;
import xyz.brassgoggledcoders.steamagerevolution.blocks.BlockPneumaticTube;
...
public class TileEntityPneumaticSender extends TileEntitySlowTick {
	...
	public void recalculateCache(World worldIn, BlockPos pos) {
		...
		for(int i = 1; i < maxDistance; i++) {
			...
			if(block == SARObjectHolder.pneumatic_router) {
			...
			else if(block == SARObjectHolder.pneumatic_tube
