...
public interface IPipe {
     ...
     */
    PipeNetworkBase getMultiblockController();
     ...
     */
    void onAttached(PipeNetworkBase newController);
     ...
     */
    void onDetached(PipeNetworkBase multiblockController);
     ...
     * @see #onDetached(PipeNetworkBase)
     */
    void onOrphaned(PipeNetworkBase oldController, int oldControllerSize, int newControllerSize);
     ...
     */
    PipeNetworkBase createNewMultiblock();
     ...
     */
    Class<? extends PipeNetworkBase> getMultiblockControllerType();
     ...
     */
    void onAssimilated(PipeNetworkBase newController);
     ...
     */
    void onMachineAssembled(PipeNetworkBase multiblockControllerBase);
     ...
     */
    Set<PipeNetworkBase> attachToNeighbors();
