...
public interface IPipeNetworkRegistry {
	 ...
	 */
	void onPartAdded(World world, IPipe part);
	 ...
	 */
	void onPartRemovedFromWorld(World world, IPipe part);
	 ...
	 */
	void addDeadController(World world, PipeNetworkBase controller);
	 ...
	 */
	void addDirtyController(World world, PipeNetworkBase controller);
}
