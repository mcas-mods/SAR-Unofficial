...
public final class PipeNetworkRegistry implements IPipeNetworkRegistry {
     ...
     */
    @Override
    public void onPartAdded(final World world, final IPipe part) {

        PipeNetworkWorldRegistry registry;
        ...
        if (this._registries.containsKey(world)) {
            ...
            registry = new PipeNetworkWorldRegistry(world);
     ...
     */
    @Override
    public void onPartRemovedFromWorld(final World world, final IPipe part) {
     ...
     */
    @Override
    public void addDeadController(final World world, final PipeNetworkBase controller) {
     ...
     */
    @Override
    public void addDirtyController(final World world, final PipeNetworkBase controller) {
    ...
    protected void tickStart(final World world) {
        ...
        if (this._registries.containsKey(world)) {
            ...
            final PipeNetworkWorldRegistry registry = this._registries.get(world);
    ...
    private PipeNetworkRegistry() {
        this._registries = new HashMap<World, PipeNetworkWorldRegistry>(2);
    }

    private HashMap<World, PipeNetworkWorldRegistry> _registries;

    public static final PipeNetworkRegistry INSTANCE = new PipeNetworkRegistry();
}