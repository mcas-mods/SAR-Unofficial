...
public class SemisolidRecipe extends SARMachineRecipe {
	...
	public SemisolidRecipe(String crafter, Ingredient[] itemInputs, IngredientFluidStack[] fluidInputs,
			SemisolidStack[] semisolidInputs, int ticksToProcess, int steamUsePerCraft, ItemStack[] itemOutputs,
			FluidStack[] fluidOutputs, SemisolidStack[] semisolidOutputs) {
	...
	public static class Builder extends MachineRecipeBuilder {
		...
		public SemisolidRecipe build() {
			// validate(); TODO
			SemisolidRecipe recipe = new SemisolidRecipe(crafter, itemInputs, fluidInputs, semisolidInputs,
					ticksToProcess, steamUsePerCraft, itemOutputs, fluidOutputs, semisolidOutputs);
