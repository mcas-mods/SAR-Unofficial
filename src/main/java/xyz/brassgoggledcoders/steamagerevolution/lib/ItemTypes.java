...
public class ItemTypes
{
	public static String[] metalsIngot =
			new String[] {"aluminum", "brass", "bronze", "cast_iron", "copper", "tin", "zinc"};
	public static String[] metalsNugget =
			new String[] {"iron", "aluminum", "brass", "bronze", "cast_iron", "copper", "tin", "zinc"};
	public static String[] metalsAll =
			new String[] {"iron", "gold", "aluminum", "brass", "bronze", "cast_iron", "copper", "tin", "zinc"};
