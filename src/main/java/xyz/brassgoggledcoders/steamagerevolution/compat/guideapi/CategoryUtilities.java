...
public class CategoryUtilities {
	...
	public static Map<ResourceLocation, EntryAbstract> buildCategory() {
		...
		ioEntry.addAll(PageHelper.pagesForLongText(com.teamacronymcoders.base.util.TextUtils.localize(keyBase + "fluid_io.info")));
		...
		steamVentEntry.addAll(PageHelper.pagesForLongText(com.teamacronymcoders.base.util.TextUtils.localize(keyBase + "steam_vent.info")));
		...
		clockworkWingsEntry.addAll(PageHelper.pagesForLongText(com.teamacronymcoders.base.util.TextUtils.localize(keyBase + "clockwork_wings.info")));
		...
		steamToolsEntry.addAll(PageHelper.pagesForLongText(com.teamacronymcoders.base.util.TextUtils.localize(keyBase + "steam_tools.info")));
		...
		aestheticEntry.addAll(PageHelper.pagesForLongText(com.teamacronymcoders.base.util.TextUtils.localize(keyBase + "aesthetic.info")));
