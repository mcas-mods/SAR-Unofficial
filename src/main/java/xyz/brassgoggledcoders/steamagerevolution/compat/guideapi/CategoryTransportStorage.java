...
public class CategoryTransportStorage {
	...
	public static Map<ResourceLocation, EntryAbstract> buildCategory() {
		...
		canisterEntry.addAll(PageHelper.pagesForLongText(com.teamacronymcoders.base.util.TextUtils.localize(keyBase + "canister.info")));
		...
		fluidHopperEntry.addAll(PageHelper.pagesForLongText(com.teamacronymcoders.base.util.TextUtils.localize(keyBase + "fluid_hopper.info")));
		...
		pneumaticsEntry.addAll(PageHelper.pagesForLongText(com.teamacronymcoders.base.util.TextUtils.localize(keyBase + "pneumatics.info")));
		...
		basicTankEntry.addAll(PageHelper.pagesForLongText(com.teamacronymcoders.base.util.TextUtils.localize(keyBase + "basic_tank.info")));
		...
		tankEntry.addAll(PageHelper.pagesForLongText(com.teamacronymcoders.base.util.TextUtils.localize(keyBase + "tank.info")));
