...
public class AlloyFurnaceTweaker {
	// @ZenMethod
	// public static void addRecipe(ILiquidStack first, ILiquidStack second,
	// ILiquidStack output) {
	// AlloyFurnaceRecipe r = new AlloyFurnaceRecipe(CTHelper.toFluidStack(first),
	// CTHelper.toFluidStack(second),
