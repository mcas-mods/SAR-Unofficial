...
public class CategoryUtilities {
	...
	public static Map<ResourceLocation, EntryAbstract> buildCategory() {
		...
		ioEntry.addAll(PageHelper.pagesForLongText(I18n.translateToLocalFormatted(keyBase + "fluid_io.info")));
		// ioEntry.add(new PageJsonRecipe(new ResourceLocation(SteamAgeRevolution.MODID,
		// "fluid_io")));
		...
		steamVentEntry.addAll(PageHelper.pagesForLongText(I18n.translateToLocalFormatted(keyBase + "steam_vent.info")));
		// steamVentEntry.add(new PageJsonRecipe(new
		// ResourceLocation(SteamAgeRevolution.MODID, "steam_vent")));
		...
		clockworkWingsEntry
				.addAll(PageHelper.pagesForLongText(I18n.translateToLocalFormatted(keyBase + "clockwork_wings.info")));
		// clockworkWingsEntry.add(new PageJsonRecipe(new
		// ResourceLocation(SteamAgeRevolution.MODID, "clockwork_wings")));
		...
		steamToolsEntry
				.addAll(PageHelper.pagesForLongText(I18n.translateToLocalFormatted(keyBase + "steam_tools.info")));
		// steamToolsEntry.add(new PageJsonRecipe(new
		// ResourceLocation(SteamAgeRevolution.MODID, "steam_sword")));
		// steamToolsEntry.add(new PageJsonRecipe(new
		// ResourceLocation(SteamAgeRevolution.MODID, "steam_pickaxe")));
		// steamToolsEntry.add(new PageJsonRecipe(new
		// ResourceLocation(SteamAgeRevolution.MODID, "steam_axe")));
		// steamToolsEntry.add(new PageJsonRecipe(new
		// ResourceLocation(SteamAgeRevolution.MODID, "steam_shovel")));
		// steamToolsEntry.add(new PageJsonRecipe(new
		// ResourceLocation(SteamAgeRevolution.MODID, "steam_hoe")));
		...
		aestheticEntry.addAll(PageHelper.pagesForLongText(I18n.translateToLocalFormatted(keyBase + "aesthetic.info")));
		// aestheticEntry.add(new PageJsonRecipe(new
		// ResourceLocation(SteamAgeRevolution.MODID, "trunk")));
